...
//                supplier: options.supplier,
        ...
        $scope.remove = function (bill) {
            if (!bill && grid) {
                return $http({method: 'DELETE', url: '/erp/api/bill', params:
                            {
        ...
        $scope.exportAccounting = function (id) {
            if (!id && grid) {
                return $http({method: 'PUT', url: '/erp/api/bill/accounting', data:
                            {
                                id: grid.getSelectedRows()
                            }
                }).success(function (data, status) {
...
MetronicApp.controller('BoxBillController', ['$rootScope', '$scope', '$http', '$timeout', '$q', function ($rootScope, $scope, $http, $timeout, $q) {
        ...
        $scope.loadCaGraph = function (date, mode) {
            ...
            $http({method: 'GET', url: '/erp/api/stats/caGraph', params: {
                    graph: true,
                    mode: mode,
                    start: date.start,
                    end: date.end
        ...
        $scope.loadCommercialCa = function (dateRange) {
            ...
            $http({method: 'GET', url: '/erp/api/stats/caCommercial', params: {
        ...
        $scope.loadCustomerCa = function (dateRange) {
            ...
            $http({method: 'GET', url: '/erp/api/stats/caCustomer', params: {
                    start: dateRange.start,
                    end: dateRange.end
                }
            }).success(function (ca, status) {
        ...
        $scope.loadCaFamily = function (date, options) {
            ...
            $http({method: 'GET', url: '/erp/api/stats/caFamily', params: {
                    start: date.start,
                    end: date.end,
                    societe: options
                }
            ...
            $http({method: 'GET', url: '/erp/api/stats/caEvolution', params: {
                    start: date.start,
                    end: date.end
                }
            }).success(function (data, status) {
